...
class _EditMangaPageState extends State<EditMangaPage> {
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildInputField('Какой том', _volumeController, hintText: 'Например, Том 1', setState: setState),
                        const SizedBox(height: 15),
                        _buildInputField('Главы', _chaptersController, hintText: 'Например, № глав: 1-36 + дополнительные истории', setState: setState),
                        const SizedBox(height: 15),
                        _buildInputField('Цена', _priceController, hintText: 'Например, 100 рублей', keyboardType: TextInputType.number, setState: setState),
                        const SizedBox(height: 15),
                        _buildTextAreaField('Описание', _fullDescriptionController, hintText: 'Введите описание', setState: setState),
                        const SizedBox(height: 15),
                        _buildDropdownField('Формат издания', _formatController, formatTexts, setState: setState),
                        const SizedBox(height: 15),
                        _buildDropdownField('Издательство', _publisherController, publisherTexts, setState: setState),
                        const SizedBox(height: 15),
                        _buildImageSelection(setState),
                        const SizedBox(height: 20),
                        ElevatedButton(
                          onPressed: _submit,
                          child: Text(
  ...
  Widget _buildInputField(String label, TextEditingController controller, {String hintText = '', TextInputType? keyboardType, required StateSetter setState}) {
    return Row(
      children: [
        Expanded(
          child: TextField(
  ...
  Widget _buildTextAreaField(String label, TextEditingController controller, {String hintText = '', required StateSetter setState}) {
    return Row(
      children: [
        Expanded(
          child: TextField(
  ...
  Widget _buildDropdownField(String label, TextEditingController controller, List<String> options, {required StateSetter setState}) {
    return Row(
      children: [
        Expanded(
  ...
  Widget _buildImageSelection(StateSetter setState) {
    return Column(
